...
import { IconVideo, IconLoader2, IconBrandGoogle, IconBrandZoom, IconBrandTeams, IconRobot } from "@tabler/icons-react"
...
const platformIcons: Record<Platform, React.ReactNode> = {
  google_meet: <IconBrandGoogle className="h-5 w-5 text-green-500" />,
